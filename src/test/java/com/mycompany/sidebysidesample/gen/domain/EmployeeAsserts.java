...
import static com.mycompany.sidebysidesample.gen.domain.AssertUtils.zonedDataTimeSameInstant;
...
public class EmployeeAsserts {
    ...
    public static void assertEmployeeUpdatableFieldsEquals(Employee expected, Employee actual) {
        assertThat(actual)
            ...
            .satisfies(a ->
                assertThat(a.getHireDate()).as("check hireDate").usingComparator(zonedDataTimeSameInstant).isEqualTo(expected.getHireDate())
            )
