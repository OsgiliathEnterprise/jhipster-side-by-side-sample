...
import static com.mycompany.sidebysidesample.gen.domain.CountryAsserts.*;
...
import com.mycompany.sidebysidesample.gen.repository.CountryRepository;
import com.mycompany.sidebysidesample.gen.service.dto.CountryDTO;
import com.mycompany.sidebysidesample.gen.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country updatedCountry = new Country().countryName(UPDATED_COUNTRY_NAME);
        // Add required entity
        Region region;
        if (TestUtil.findAll(em, Region.class).isEmpty()) {
            region = RegionResourceIT.createUpdatedEntity();
            em.persist(region);
            em.flush();
        } else {
            region = TestUtil.findAll(em, Region.class).get(0);
