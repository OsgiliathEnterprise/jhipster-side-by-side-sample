...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Mauricio');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Mauricio');

      cy.get(`[data-cy="lastName"]`).type('Torp');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Torp');

      cy.get(`[data-cy="email"]`).type('Kenyon_Stark46@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Kenyon_Stark46@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('aw favorable unlike');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'aw favorable unlike');

      cy.get(`[data-cy="hireDate"]`).type('2025-07-05T09:17');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-07-05T09:17');

      cy.get(`[data-cy="salary"]`).type('25561');
      cy.get(`[data-cy="salary"]`).should('have.value', '25561');

      cy.get(`[data-cy="commissionPct"]`).type('7997');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '7997');
