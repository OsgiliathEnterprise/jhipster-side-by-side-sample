...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Investor Implementation Supervisor');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Investor Implementation Supervisor');

      cy.get(`[data-cy="minSalary"]`).type('27955');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '27955');

      cy.get(`[data-cy="maxSalary"]`).type('26916');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '26916');
