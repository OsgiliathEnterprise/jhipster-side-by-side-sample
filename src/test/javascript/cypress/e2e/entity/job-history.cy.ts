...
describe('JobHistory e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/employees',
      body: {"firstName":"Ruthie","lastName":"Strosin","email":"Jarred.Konopelski@hotmail.com","phoneNumber":"without blushing duh","hireDate":"2025-07-04T19:56:42.633Z","salary":25247,"commissionPct":29415},
    }).then(({ body }) => {
      employee = body;
    });
  });
  ...
  describe('new JobHistory page', () => {
    ...
    it.skip('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2025-07-04T18:20');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2025-07-04T18:20');

      cy.get(`[data-cy="endDate"]`).type('2025-07-04T23:54');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2025-07-04T23:54');
